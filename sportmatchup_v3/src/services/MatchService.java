...
//				request.setAttribute("completedMatch", inqTotComMatList(bList2));
	...
	// 2 - 1 -1 (done) 내가 생성한 경기에 신청한 회원을 뿌려주는 메서드
	...
	private String inqMatchFix(LinkedList<Bean> bList1, LinkedList<Bean> bList2, Bean b) {
		...
		inqPerAppMatListInfo.append("<tr><td>경기상태</td><td>경기 생성자</td><td>경기 종목</td><td>인원<br/>현재 / 경기 제한</td><td>지역</td><td>날짜 & 시간</td></tr><tr><td>");
	...
	// 17 (done) 완료된 내가 생성한 매치 삭제(update)
	...
	// 18 (done) 완료된 내가 신청한 매치 삭제(update)
