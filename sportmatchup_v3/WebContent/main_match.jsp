...
<nav class="navbar navbar-inverse">
	...
	<div id="wrap">
		<div id="container" style="height: 669px;">
			...
			<div id="content">
				<div class="c_header"
					style="background-color: rgba(255, 255, 255, 0.80); height: 650px; padding-top: 15px; padding-left: 15px; overflow: scroll; overflow-x: hidden;">
					<h2>나의 경기 목록<font style = "color :red;">${message }</font></h2>

					<p class="contxt" >${gameIcreated}
						${gameIapplied} ${fixedmatch } ${completedCreateMatch} ${completedApplyMatch}
						 ${applicableMatch } ${applicableMatch } ${applicableMatchtotal} ${matchFix }
						${acceptMemberInfo } ${completedMatch} ${matchApplyInfo }</p>
				</div>
