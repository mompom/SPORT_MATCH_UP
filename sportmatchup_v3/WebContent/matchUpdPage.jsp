			...
			<div class="contact-form1">
				<div class="contact-w3-agileits">
					...
					<div class="form-sub-w3ls">
						<input placeholder="시작 전 한마디" name="description" type="text"
							required>
					...
					<div class="form-sub-w3ls">
						...
						</select> <select name="fixdate" id="fixdate">
						</select><br /> <select name="fixtime" id="fixtime">
						</select> <select name="fixminute" id="fixminute">
						</select>
					</div>
					<div>
						<!--                경기 종목 -->
				...
				<div class="submit-w3l">
					<input type="button" value="경기 수정 하기" onClick="matchcreateupd()" />
					<input type="button" value="뒤로 가기" onClick="mymatchinfo()" />
				</div>
			</div>
		</form>
	</div>
