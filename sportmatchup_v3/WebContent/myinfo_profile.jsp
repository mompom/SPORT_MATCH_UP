...
<div id="wrap">
	<div id="container" style="height: 669px;">
		<!-- CONTENTS -->
		<div id="content">
    <div class="c_header" style="background-color : rgba(249,249,249,0.80);height: 133px; padding-top: 15px; padding-left: 15px;">
        <h2>프로필 수정</h2>
    ...
    <form id="profileForm" method="post" enctype="multipart/form-data">
        <fieldset>
            ...
            <table border="0" class="tbl_model">
                ...
                <tr>
                    <th scope="row">
                        <div class="thcell"><h3>프로필 사진</h3></div>
                    </th>
                    <td>
                        <div class="tdcell" style="background-color : rgba(249,249,249,0.80);">
                            <div class="profile_photo">
                                <img id="imgThumb" src="https://phinf.pstatic.net/contact/20170727_224/1501150041973RJYB1_JPEG/image.jpg?type=s160" width="100" height="100">
            ...
            <div class="btn_wrap">
                <a href="javascript:;" class="btn_model"><b id="btnConfirm" class="btn8 btn_disable" style="height: 31px;">적용</b></a>
                <a onclick="memberInfo()" class="btn_model"><b id="btnCancel" class="btn2">취소</b></a>
            </div>
        </fieldset>
    </form>
